...
import {matchTranslationLanguage, getTranslationValue, T} from '/fable_output/Translations.js'
...
describe("Translations", () => {
    ...
    it("T can give default values", () => {
        ...
        obs
            ...
            .Broadcast([{"en-us": {lastName: "Last Name"}}, Language.FromString("en-us")])
            .Broadcast([{"es-mx": {lastName: "Apellido"}}, Language.FromString("es-mx")])
